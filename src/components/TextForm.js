...
export default function TextForm(props){
    ...
    <div style={{color: props.mode === "light" ? "black" : "white"}} className="container">
        <h1>{props.heading}</h1>
            <div className='mb-3'>
            <textarea style={{backgroundColor: props.mode === "light" ? "white" : "grey" , color: props.mode === "light" ? "black" : "white"}} onInput={countCharacters} className="form-control" onChange={handleOnChange} 
        ...
        <button onClick={handleLCLick} style={{color: 'white', backgroundColor: props.color}} className='btn ms-3'>Convert to Lowercase</button> 
        <button onClick={copyText} style={{color: 'white', backgroundColor: props.color}} className='btn ms-3'>Copy Text</button>
        <button onClick={removeExtraSpaces} style={{color: 'white', backgroundColor: props.color}} className='btn ms-3'>Remove Extra Spaces</button>
        <button onClick={clearText} style={{color: 'white', backgroundColor: props.color}} className='btn ms-3'>Clear Text</button>
    </div>
